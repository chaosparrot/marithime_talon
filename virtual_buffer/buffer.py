...
from .indexer import text_to_phrase, normalize_text, reindex_tokens, text_to_virtual_buffer_tokens, can_merge_tokens
...
class VirtualBuffer:
    ...
    def detect_merge_strategy(self, token_index: int, token_character_index: int, token: VirtualBufferToken) -> (int, int, int):
        ...
        if len(self.tokens) != 0:
            ...
            previous_token = None if token_index - 1 < 0 else self.tokens[token_index - 1]
