...
def test_detect_self_repair(assertion):
    ...
    assertion( "            Should result in a detected self repair", vb.detect_self_repair(["paragraph", "word"]) == True )
    assertion( "        Inserting the words 'a new paragraph with a new word'... ") 
    assertion( "            Should result in a detected self repair", vb.detect_self_repair("a new paragraph with a new word".split()) == True )
    ...
    assertion( "            Should result in a detected self repair", vb.detect_self_repair(["a", "paragraph"]) == True )
    assertion( "    Replacement of word")
    assertion( "        Inserting the words 'a new word'...")
    assertion( "            Should result in a detected self repair", vb.detect_self_repair(["a", "new", "word"]) == True )
    assertion( "    Insertion in between words")
    assertion( "        Inserting the words 'a new word paragraph'... ")
    assertion( "           Should result in a detected self repair", vb.detect_self_repair(["a", "new", "word", "paragraph"]) == True )
    assertion( "    Insertion and appending")
    assertion( "        Inserting the words 'an old paragraph insert'... ")
    assertion( "           Should result in a detected self repair", vb.detect_self_repair(["a", "new", "word", "paragraph", "insert"]) == True )
...
def test_add_known_self_repair_examples(assertion):
    ...
    assertion( "        Should result in self repair", vb.detect_self_repair(["this", "is", "the", "test"]) == True)
    assertion( "    Inserting 'formulate a paragraph' after 'formulate a sentence'")
    vb = get_filled_vb_with_examples(["formulate", "a", "sentence"])
    assertion( "        Should result in self repair", vb.detect_self_repair(["formulate", "a", "paragraph"]) == True)
    ...
    assertion( "        Should result in self repair", vb.detect_self_repair(["we", "tend", "to", "repeat", "the", "words"]) == True)
