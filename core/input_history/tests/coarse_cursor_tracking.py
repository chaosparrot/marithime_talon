...
print( "    Expect double word length to be 2", len(items) == 2 )
items = cpt.split_string_with_punctuation("Testing  items")
print( "    Expect double word, with two spaces in between length to be 2", len(items) == 2 )
items = cpt.split_string_with_punctuation("Testing-items")
print( "    Expect word with dashes length to be 2", len(items) == 2 )
items = cpt.split_string_with_punctuation("Words... don't come easy")
print( "    Expect 'Words... don't come easy' length to be 5", len(items) == 5 )
print( "    Expect 'Words' to be the first split", items[0] == "Words" )
print( "    Expect 'don' to be the second split", items[1] == "don" )
items = cpt.split_string_with_punctuation("""This is a 
                                          split sentence. """)
print( "    Expect a sentence with new lines to have a length of 5", len(items) == 5 )

print( "Coarse cursor traxcking with a filled input history")
...
print( "    Moving left twice...")
input_history.apply_key("left:2")
cursor_index = input_history.cursor_position_tracker.get_cursor_index(True)
print( "        Expect cursor line index to be 1", cursor_index[0] == 1)
print( "        Expect coarse character index to be two characters inside the word sentence (3)", cursor_index[1] == 3)
print( "    Moving right twice...")
...
cursor_index = input_history.cursor_position_tracker.get_cursor_index(True)
print( "        Expect cursor line index to be lost", cursor_index[0] == -1 )
...
print( "    Pressing home to go to the start of the third sentence...")
