...
def test_determine_single_word_fixes(assertion):
    ...
    assertion( "        Should not find more fixes to cycle through for the second word", cycle_fixes[1][1] == 0)
...
def test_determine_no_fixes_with_different_starting_words(assertion):
    ...
    assertion( "        Should find all the text inserted", len(cycle_fixes) == 1)
    assertion( "        Should find a single fix to cycle through", cycle_fixes[0][1] == 1)
    assertion( "        Should have 'cause' as a second option", cycle_fixes[0][0][1] == "cause")
...
def test_determine_single_word_fixes_with_different_starting_words(assertion):
    ...
    assertion( "        Should find all the text inserted", len(cycle_fixes) == 1)
    assertion( "        Should find three fixes to cycle through", cycle_fixes[0][1] == 3)
    assertion( "        Should find have the second option as 'towards'", cycle_fixes[0][0][1] == "towards")
    assertion( "    Checking 'to the'... with 'towards the'")
    cycle_fixes = input_fixer.determine_cycles_for_words(["to", "the"], ["towards", "the"])
    assertion( "        Should find all the text inserted", len(cycle_fixes) == 2)
    assertion( "        Should find three fixes to cycle through for the first word", cycle_fixes[0][1] == 3)
    assertion( "        Should find have the second option as 'towards'", cycle_fixes[0][0][1] == "towards")
    assertion( "        Should not find more fixes to cycle through for the second word", cycle_fixes[1][1] == 0)
...
def test_determine_multiple_word_fixes_with_different_starting_words(assertion):
    ...
    assertion( "        Should find all the text inserted", len(cycle_fixes) == 2)
    assertion( "        Should find three fixes to cycle through for the first word", cycle_fixes[0][1] == 3)
    assertion( "        Should find three fixes to cycle through for the second word", cycle_fixes[1][1] == 3)    
    ...
    assertion( "        Should find three fixes to cycle through for the first word", cycle_fixes[0][1] == 3)
    assertion( "        Should find no fixes to cycle through for the second word", cycle_fixes[1][1] == 0)    
    assertion( "        Should find three fixes to cycle through for the third word", cycle_fixes[2][1] == 3)
