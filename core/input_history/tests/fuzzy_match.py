...
def test_fuzzy_matching(assertion):
    ...
    input_history.insert_input_events(text_to_input_history_events("an ", "an"))
    input_history.insert_input_events(text_to_input_history_events("ad ", "ad"))
    input_history.insert_input_events(text_to_input_history_events("that ", "that"))
    input_history.insert_input_events(text_to_input_history_events("will ", "will"))
    input_history.insert_input_events(text_to_input_history_events("get ", "get"))
    input_history.insert_input_events(text_to_input_history_events("attention.", "attention"))
