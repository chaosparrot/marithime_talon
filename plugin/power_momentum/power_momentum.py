from talon import cron, Context, Module, ctrl, app, actions
...
# Register stop scrolling to cancelable tasks
def register_stop_scroll():
    actions.user.cancelable_tasks_append(lambda : actions.user.power_momentum_stop())

app.register("ready", register_stop_scroll)
