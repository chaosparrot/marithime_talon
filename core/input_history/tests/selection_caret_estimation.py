...
def test_single_line_estimation(assertion):
    ...
    location = input_indexer.determine_cursor_position("test", "This is a test.")
...
This adds to the sentence and turns it into a small paragraph."""
    ...
    location = input_indexer.determine_cursor_position("This is", multiline_haystack)
    ...
    location = input_indexer.determine_cursor_position("sentence.", multiline_haystack)
    assertion("    The word 'sentence.' should be found at line 0, 0 characters away from the end", location == (0, 0))
    location = input_indexer.determine_cursor_position("paragraph.", multiline_haystack)
    assertion("    The words 'paragraph.' should be found at line 1, 0 characters away from the end", location == (1, 0))
    location = input_indexer.determine_cursor_position("and",multiline_haystack)    
    assertion("    The characters 'and' should be found at line 1, 33 characters away from the end", location == (1, 33))
    location = input_indexer.determine_cursor_position("testing", multiline_haystack)
    assertion("    The word 'testing' should not be found", location == (-1, -1))
    location = input_indexer.determine_cursor_position("This", multiline_haystack)
...
"""
    ...
    location = input_indexer.determine_cursor_position(multiline_needle_paragraph, multiline_haystack)
    assertion("    The sequence 'paragraph.<newline>' should not be found as no newline exists after paragraph", location == (-1, -1))
    location = input_indexer.determine_cursor_position(multiline_needle_test, multiline_haystack)    
