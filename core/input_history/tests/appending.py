...
def text_to_input_history_event_replacement(assertion):
    assertion( "    Expect event without phrase is expected phrase", text_to_input_history_events("Insert")[0].phrase == "insert")
    assertion( "    Expect event with special characters without phrase with added whitespace is expected phrase", text_to_input_history_events(" Insert ")[0].phrase == "insert")
    assertion( "    Expect event with special characters without phrase is expected phrase", text_to_input_history_events("Insert;.-=()")[0].phrase == "insert")
    assertion( "    Expect event with special characters with phrase is expected phrase", text_to_input_history_events("Insert;.", "insert semi dot")[0].phrase == "insert semi dot")
    assertion( "    Expect line ending to insert two events", len(text_to_input_history_events("\n")) == 2) 
    assertion( "    Expect line ending to insert empty phrase event", text_to_input_history_events("\n")[0].phrase == "")
    assertion( "    Expect 'that's' to become thats as a phrase", text_to_input_history_events("that's")[0].phrase == "thats")
    assertion( "    Expect 'we’re' to become were as a phrase", text_to_input_history_events("we’re")[0].phrase == "were")
    assertion( "    Expect 'I'm' to become im as a phrase", text_to_input_history_events("i'm")[0].phrase == "im") 
...
def detect_insert_strategies(assertion):
    ...
    empty_ihm.insert_input_events(text_to_input_history_events("This ", "This"))
    ...
    empty_ihm.insert_input_events(text_to_input_history_events("is ", "is"))
    ...
    empty_ihm.insert_input_events(text_to_input_history_events("a ", "a"))
    ...
    empty_ihm.insert_input_events(text_to_input_history_events("test.", "test"))
...
def appending_to_history(assertion):
    ...
    input_history.insert_input_events(text_to_input_history_events("another word ", "another word"))
    ...
    assertion( "    After adding another input event")
    input_history.insert_input_events(text_to_input_history_events("until it is a valid sentence.", "until it is a valid sentence"))
    ...
    input_history.insert_input_events(text_to_input_history_events("This is the second sentence.", "this is the second sentence"))
