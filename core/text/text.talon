...
phrase <user.text>$:
    ...
    insert(text)
phrase <user.text> quilt:
    user.add_phrase_to_history(text)
    insert(text)
{user.prose_formatter} <user.prose>$: user.insert_formatted(prose, prose_formatter)
{user.prose_formatter} <user.prose> quilt: user.insert_formatted(prose, prose_formatter)
<user.format_text>+$: user.insert_many(format_text_list)
<user.format_text>+ quilt: user.insert_many(format_text_list)
