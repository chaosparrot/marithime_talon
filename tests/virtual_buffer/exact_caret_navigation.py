...
def test_single_line_exact_caret_navigation(assertion):
    ...
    keys = vb.go_phrase("insert", next_occurrence=False)
    ...
    keys = vb.go_phrase("insert", "start", next_occurrence=False) 
    ...
    keys = vb.go_phrase("new", "start", next_occurrence=False)
    ...
    keys = vb.go_phrase("word", "end", next_occurrence=False)
    assertion( "        Expect right to be pressed 9 times", keys[0] == "right:9")
    caret_index = vb.caret_tracker.get_caret_index() 
    assertion( "        Expect caret line index to be 0", caret_index[0] == 0)
    ...
    keys = vb.go_phrase("bee", "end", next_occurrence=False)
...
def test_multi_line_exact_caret_navigation(assertion):
    ...
    vb.insert_tokens(text_to_virtual_buffer_tokens("new ", "new"))
    vb.insert_tokens(text_to_virtual_buffer_tokens("word.", "word"))
    vb.go_phrase("insert", next_occurrence=False)
    vb.go_phrase("insert", "start", next_occurrence=False)
    vb.go_phrase("new", "start", next_occurrence=False)
    vb.go_phrase("word", "end", next_occurrence=False)
    vb.go_phrase("bee", "end", next_occurrence=False)
    ...
    keys = vb.go_phrase("sentence", next_occurrence=False) 
    ...
    keys = vb.go_phrase("line", next_occurrence=False)
    ...
    keys = vb.go_phrase("final", next_occurrence=False)
    caret_index = vb.caret_tracker.get_caret_index()
