...
text = input_fixer.automatic_fix("too", "want", "make")
print( "        Should not change the text automatically because the automatic fixes aren't persisted yet", text == "too")
print( "    Adding another fix for 'want too make' and inserting it again...")
input_fixer.add_fix("too", "to", "want", "make")
text = input_fixer.automatic_fix("too", "want", "make")
...
text = input_fixer.automatic_fix("period", "a", "of")
print( "        Should not change the text automatically because the automatic fixes aren't persisted yet", text == ".")
print( "    Adding another fix for 'a . of' and inserting it again...")
input_fixer.add_fix(".", "period", "a", "of")
text = input_fixer.automatic_fix("period", "a", "of")
