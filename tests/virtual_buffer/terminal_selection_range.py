...
def test_virtual_select_single_word_and_extending(assertion):
    ...
    assertion( "        Should start the virtual selecting with 'Insert '", vb.virtual_selection and vb.virtual_selection[0].text == 'Insert ')    
    ...
    assertion( "        Should end the virtual selecting with 'new '", vb.virtual_selection and vb.virtual_selection[-1].text == 'new ')
    assertion( "        Should not deselect the previous selection", keys[0] not in ["left", "right"])
    ...
    assertion( "        Should not deselect the previous selection", keys[0] not in ["left", "right"])
    assertion( "        Should end the virtual selecting with 'sentence.'", vb.virtual_selection and vb.virtual_selection[-1].text == 'sentence.')    
