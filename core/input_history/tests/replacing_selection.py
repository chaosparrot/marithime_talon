...
print( "        Expect text to be merged", input_history.input_history[1].text == "Insert a second-sentence. \n")
print( "        Expect phrase to be merged", input_history.input_history[1].phrase == "insert a second sentence")
...
print( "        Expect no selection detected", input_history.is_selecting() == False)
print( "        Expect text to be merged", input_history.input_history[1].text == "Insert a second-gentence. \n")
print( "        Expect phrase to be merged", input_history.input_history[1].phrase == "insert a second gentence")
