...
Insert a third sentence."""
    ...
    input_history.insert_input_events(text_to_input_history_events("G"))
    ...
    input_history.insert_input_events(text_to_input_history_events(" and "))
    ...
    input_history.insert_input_events(text_to_input_history_events("But also... "))
...
def test_multiple_event_replacement_left(assertion):
    ...
    input_history.insert_input_events(text_to_input_history_events("rat"))
    ...
    input_history.insert_input_events(text_to_input_history_events("ilat"))
...
def test_multiple_event_replacement_right(assertion):
    ...
    input_history.apply_key("shift:down right shift:up")
    input_history.insert_input_events(text_to_input_history_events("or"))
    assertion( "        Expect history length to be one less (3)", len(input_history.input_history) == 3)
    cursor_index = input_history.cursor_position_tracker.get_cursor_index()
    assertion( "        Expect cursor line index to be 0", cursor_index[0] == 0)
    ...
    input_history.insert_input_events(text_to_input_history_events("in"))
    assertion( "        Expect history length to be two less (1)", len(input_history.input_history) == 1)
    cursor_index = input_history.cursor_position_tracker.get_cursor_index()
    assertion( "        Expect cursor line index to be 0", cursor_index[0] == 0)
