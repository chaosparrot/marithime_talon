...
print("     Pressing delete until two events are merged")
...
print( "        Expect cursor character index to be before the second final word of the sentence", cursor_index[1] == 11)
...
print( "        Expect cursor line index to be 2", cursor_index[0] == 2)
print( "        Expect cursor character index to be before the second final word of the sentence", cursor_index[1] == 7)
input_index = input_history.determine_input_index()
print( "        Expect input index to be 2", input_index[0] == 2)
print( "    Pressing delete until more than two event are removed...")
