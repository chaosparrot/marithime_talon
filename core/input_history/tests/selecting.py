...
print( "        Expect ' ' selected detected", input_history.cursor_position_tracker.get_selection_text() == ' ')
...
print( "        Expect the selection to be ' a second '", input_history.cursor_position_tracker.get_selection_text() == ' a second ')
